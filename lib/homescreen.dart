...
class Zidane extends StatefulWidget {
  const Zidane({super.key});

  @override
  State<Zidane> createState() => _ZidaneState();
}

class _ZidaneState extends State<Zidane> {
  bool isLoaded = false;
  late num temp;
  late num press;
  late num hum;
